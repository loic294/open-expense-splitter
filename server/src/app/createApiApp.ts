...
import type { D1Database, D1PreparedStatement } from "../platform/sql-adapter";

type Variables = { auth: AuthContext | null };
type HonoCtx = { Variables: Variables };
...
function requireAuth(c: { get: (key: string) => any }): AuthContext {
...
function buildInviteUrl(path: string, frontendBaseUrl: string): string {
